        ...
        this.sampleSetsStandard = {
            'Piano': {
                ...
                options: {
                    ...
                    release: 1.8,
                    attack: 0.003,
                    baseUrl: 'https://cdn.jsdelivr.net/gh/nbrosowsky/tonejs-instruments@master/samples/piano/'
                }
            },
            'Guitar': {
                type: 'sampler',
            ...
            'Strings': {
                ...
                options: {
                    urls: {
                        ...
                        'C4': 'C4.mp3', 'F4': 'F4.mp3', 'A4': 'A4.mp3', 'C5': 'C5.mp3'
                    },
                    release: 2.5,
                    attack: 0.08,
                    baseUrl: 'https://cdn.jsdelivr.net/gh/nbrosowsky/tonejs-instruments@master/samples/strings/'
                }
            }
        };
